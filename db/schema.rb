...
ActiveRecord::Schema.define(version: 20_180_529_212_300) do
  ...
  create_table 'billing_addresses', force: :cascade do |t|
    ...
    t.index %w[billing_a_type billing_a_id], name: 'index_billing_addresses_on_billing_a_type_and_billing_a_id'
  end
  ...
  create_table 'shipping_addresses', force: :cascade do |t|
    ...
    t.index %w[shipping_a_type shipping_a_id], name: 'index_shipping_addresses_on_shipping_a_type_and_shipping_a_id'
  end
